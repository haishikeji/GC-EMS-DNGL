        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="名称">
              <a-input placeholder="请输名称" v-model="queryParam.name"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
...
<script>
  ...
  import EnergyTypeModal from './modules/EnergyTypeModal'
  ...
  export default {
    ...
    data () {
      return {
        description: 'base_energy_type管理页面',
        // 表头
        columns: [
          {
            title: '序号',
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'id',text:'能源分类ID'})
